    ...
    return `<!DOCTYPE html><html><head><meta charset='UTF-8'><style>
      *{box-sizing:border-box;font-family:'Segoe UI',Arial,sans-serif}
      ...
      <div class='header'>
        <div class='brand'>
          <img src='${logoUrl}' />
          <div><div class='brand-name'>FIRST TRACK</div><div class='brand-sub'>Courier & Cargo</div></div>
        </div>
        <div class='contact'>info@firsttrack.site<br/>https://firsttrack.site</div>
      </div>
      <div class='section'>
      ...
      <div class='footer'>Thank you for shipping with First Track Courier & Cargo</div>
    </body></html>`;
  };

...
const MerchantInvoiceModal = ({ open, onClose, merchantId }) => {
  ...
  const filename = `Invoice-INV${merchantId}${year}${String(month).padStart(2,'0')}.pdf`
      ...
      <div className='relative p-6 w-[400px] bg-white rounded-2xl overflow-hidden space-y-5'>
        ...
        <form className='space-y-4' onSubmit={submit}>
          ...
          <div className='flex justify-end space-x-2 pt-2'>
            ...
            <button type='submit' className={`px-4 py-2 rounded text-white ${loading ? 'bg-blue-300 cursor-not-allowed' : 'bg-blue-500'}`} disabled={loading}>

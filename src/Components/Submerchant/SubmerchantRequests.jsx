	...
	return (
		<div className='w-full p-4 border rounded-lg bg-white flex flex-col space-y-2'>
			...
			<div className='pt-2 flex items-center space-x-2'>
				<button
					className={`px-4 py-2 rounded text-white ${acceptDisabled || actionLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-700'}`}
				...
				<button
					className={`px-4 py-2 rounded text-white ${actionLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-700'}`}

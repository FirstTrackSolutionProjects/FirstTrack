...
import getMySubmerchantTransactionsService from '@/services/transactionServices/getMySubmerchantTransactionsService';
...
const columns = [
  ...
  { field: 'submerchant_details', headerName: 'Submerchant Details', minWidth: 250,
      renderCell: (params) => (
...
const MySubmerchantTransactions = () => {
  // Data state
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const data = await getMySubmerchantTransactionsService({
        page,
      ...
      <div className='w-full max-w-7xl px-4 flex flex-col gap-4'>
        ...
        <div className='bg-blue-500 text-white p-4 rounded-lg space-y-4'>
          <div className='grid md:grid-cols-7 gap-2'>
            ...
            <input name='submerchantIdentifier' value={filters.submerchantIdentifier} onChange={handleFilterChange} placeholder='Name, Email or Mobile' className='p-2 rounded text-black bg-white'/>
              ...
              onClick={async () => {
                try {
                  const payload = {
                    ...
                    awb: filters.awb,
                    submerchantIdentifier: filters.submerchantIdentifier,
...
export default MySubmerchantTransactions;

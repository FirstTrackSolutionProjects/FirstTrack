...
const Listing = ({ step, setStep }) => {
    ...
    const fetchData = async () => {
      ...
      try {
        const queryParams = new URLSearchParams({
          page,
          ...(debouncedFilters.submerchantIdentifier && { submerchantIdentifier: debouncedFilters.submerchantIdentifier }),
        ...
        const response = await fetch(`${API_URL}/merchant/submerchants/shipments?${queryParams}`, {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': localStorage.getItem('token'),
          },
  ...
  const columns = [
    ...
    { field: 'submerchant_details', headerName: 'Submerchant Details', width: 250,
      renderCell: (params) => (
...
{/* Filters */}
      ...
      >
        {[
          { label: 'Submerchant Name/Email/Phone', name: 'submerchantIdentifier' },
...
export default MySubmerchantShipments;

    ...
    return (
        <>
            <div
                ...
                className={`cursor-pointer px-2 w-full h-12 ${isCurrentMenu ? 'bg-green-500' : 'bg-black'} text-white focus:outline-none transition-all duration-300 hover:bg-green-400 relative flex items-center ${sidebarExpanded ? 'justify-start' : 'justify-center'}`}
            >

...
export const menuItems = [
  ...
  // },
  {
    ...
    dropDownOptions: [
      {
        icon: IndianRupee,
        name: "Create B2C Batch",
        isDropdown: false,
        url: 'bulk-shipment/create-b2c-batch',
        component: CreateB2CBulkBatch,
        dropDownOptions: [{}]
      },
      {
        icon: IndianRupee,
        name: "Manage B2C Batch",
        isDropdown: false,
        url: 'bulk-shipment/manage-b2c-batch',
        component: ManageB2CBulkBatch,
        dropDownOptions: [{}]
      }
    ]
  },
